...
public record HelpSection(string Title, string Body);

public partial class HelpViewModel(MainViewModel shell) : ViewModelBase
{
    ...
    public List<HelpSection> Sections { get; } = IsFrench ? FrenchSections() : EnglishSections();

    [RelayCommand]
    private void Back() => shell.CloseHelp();
    ...
    private static List<HelpSection> FrenchSections() => new()
    {
        ...
        new("Constructs, liens et activation finale",
    ...
    private static List<HelpSection> EnglishSections() => new()
    {
        ...
        new("Constructs, links and final activation",
